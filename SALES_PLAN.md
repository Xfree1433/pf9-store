...
**Engagement window:** 90 days, renewable
...
| **Property management** | LANDLORDR, TENANTLINK, PERMITR, TASKFLOW | TBD — Cowork to audit pricing page | Low-touch: self-serve, SEO + paid search |
...
- **Paid:** Google Search on long-tail manufacturing terms ("shift handoff software small shop", "inventory app no per user fee"); LinkedIn ads targeted at Plant Manager / Ops Director at 50–500-employee manufacturers. Starting budget: $3k/mo Google, $2k/mo LinkedIn.
...
- **Paid media:** $5k/mo starting, scale with CAC
- **Tooling:** CRM, email sender, list provider — target under $500/mo
- **Cowork fee:** TBD in SOW
- **Content production:** 2 posts/week, 1 case study every 6 weeks

Total first-90-day spend ceiling: **$30k excluding Cowork fee.** Anything above requires written approval.
